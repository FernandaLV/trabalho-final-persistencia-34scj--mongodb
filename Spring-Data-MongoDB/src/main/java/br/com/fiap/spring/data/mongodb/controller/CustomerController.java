package br.com.fiap.spring.data.mongodb.controller;

import br.com.fiap.spring.data.mongodb.dto.customer.AddressDTO;
import br.com.fiap.spring.data.mongodb.dto.customer.CustomerRequest;
import br.com.fiap.spring.data.mongodb.dto.customer.CustomerResponse;
import br.com.fiap.spring.data.mongodb.dto.customer.PhoneDTO;
import br.com.fiap.spring.data.mongodb.model.Customer;
import br.com.fiap.spring.data.mongodb.service.CustomerService;
import br.com.fiap.spring.data.mongodb.model.Address;
import br.com.fiap.spring.data.mongodb.model.enums.AddressType;
...
import static br.com.fiap.spring.data.mongodb.utils.UtilMethods.toDate;
import static br.com.fiap.spring.data.mongodb.utils.UtilMethods.toDateString;
...
public class CustomerController {
     ...
     */
    private Customer getCustomer(String id, String name, String surname, Date birthDate, char gender,
     ...
     */
    private Set<Address> toModelAddresses(String id, List<AddressDTO> addressDTO) {
        ...
        addressDTO.stream().forEach(address -> addressModel.add(new Address(address.getStreetName(),
                ...
                address.getProvince(), address.getCountry(), AddressType.toEnum(address.getType())
        )));
        return addressModel;
    }
}