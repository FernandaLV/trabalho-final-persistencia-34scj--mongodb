...
import br.com.fiap.spring.data.mongodb.dto.category.CategoryDTO;
import br.com.fiap.spring.data.mongodb.dto.product.ProductRequest;
import br.com.fiap.spring.data.mongodb.dto.product.ProductResponse;
...
public class ProductController {
    ...
    private List<Category> toCategoriesModel(List<CategoryDTO> categoriesDTO) {
        ...
        categoriesDTO.stream().forEach(category -> categoriesModel.add(new Category(category.getId(), null)));
