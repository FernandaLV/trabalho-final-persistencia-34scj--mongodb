...
import br.com.fiap.spring.data.mongodb.dto.salesOrder.ProductDTO;
import br.com.fiap.spring.data.mongodb.dto.salesOrder.SalesOrderRequest;
import br.com.fiap.spring.data.mongodb.dto.salesOrder.SalesOrderRequestUpdate;
import br.com.fiap.spring.data.mongodb.dto.salesOrder.SalesOrderResponse;
...
import br.com.fiap.spring.data.mongodb.model.SalesOrderItemPK;
...
import static br.com.fiap.spring.data.mongodb.model.enums.AddressType.ENTREGA;
...
public class SalesOrderController {
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/{id}",
            produces = "application/json", headers = "Accept=application/json" )
    public ResponseEntity<?> deleteSalesOrder(@PathVariable("id") String id){
    ...
    @RequestMapping(method = RequestMethod.PUT, value = "/{id}",
            produces = "application/json", headers = "Accept=application/json" )
    public ResponseEntity<?> updateSalesOrder(@PathVariable("id") String id,
     ...
     */
    private Set<SalesOrderItem> toSalesOrderItem(String id, List<ProductDTO> products){
