...
import br.com.fiap.spring.data.mongodb.dto.inventory.InventoryRequest;
import br.com.fiap.spring.data.mongodb.dto.inventory.InventoryResponse;
...
public class InventoryController {
    ...
    public ResponseEntity<InventoryResponse> getInventoryByProductId(@PathVariable("id") String id){
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/{id}",
            produces = "application/json", headers = "Accept=application/json" )
    public ResponseEntity<?> deleteInventoryByProductId(@PathVariable("id") String id){
        Inventory inventory = inventoryService.getInventoryItemByProductId(id);
    ...
    @RequestMapping(method = RequestMethod.PUT, value = "/{id}",
            produces = "application/json", headers = "Accept=application/json" )
    public ResponseEntity<?> updateInventoryByProductId(@PathVariable("id") String id,
